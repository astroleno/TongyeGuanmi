...
- `method-top landed` and `method-bottom landed` preserve the read-complete semantics with only the active method scene visible.
- `method-bottom-to-figure2` uses the horizontal bottom-up WebGL ink curtain before the Figure2 scene becomes visible.
