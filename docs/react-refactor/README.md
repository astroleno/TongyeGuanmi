...
- v4 exact RSS 为 1,423,048,704B，manifest 与 rollback 均通过；最终默认 E2E 暴露的两个缺口已在 `6cde26d` 由 54 个 focused unit/integration tests 与 2/2 focused browser cases 验证。含 v5 workflow/docs 的 `e491e01` 已通过 83 files / 568 tests、lint、typecheck、build、release/static 与 bundle budgets。
