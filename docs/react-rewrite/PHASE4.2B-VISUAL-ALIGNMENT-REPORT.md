...
Results:
- `npm test -- --run`: 18 files / 100 tests passed.
- `npm run build`: passed.
- `validate:phase42-aod-fidelity`: 2 passed.
- `validate:phase42-bundle`: main gzip `78069`, GSAP gzip `27017`.
...
{
  "hero": {
    "clipPath": "circle(23.9032% at 50% 50%)",
    "inkDirection": "center-out"
  },
  "compound": {
    "toLayerOpacity": 0.506818,
    "inkDirection": "center-out",
    "progressMode": "store",
    "progressStart": "0.62"
  },
  "beliefToAod": {
    "clipPath": "polygon(0px 91.6008%, 100% 91.6008%, 100% 100%, 0px 100%)",
