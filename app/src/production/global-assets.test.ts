...
describe('production global assets', () => {
  ...
  it('keeps the main baseline order for sans and traditional-serif fallbacks', () => {
    ...
    expect(styles).toContain('--font-traditional: "Songti SC", "STSong", "Noto Serif CJK SC", "Source Han Serif SC", serif;');
    expect(styles).not.toMatch(/--font-traditional:[^;]*\bui-serif\b/);
