...
describe('portrait spike route helpers', () => {
  it('mounts the current mobile preview from its short version route', () => {
    ...
    expect(portraitSpikeRouteForSearch('?v=40')).toBe('b');
    expect(portraitSpikeRouteForSearch('?v=42')).toBe('b');
    expect(portraitSpikeRouteForSearch('?v=43')).toBe('b');
    expect(portraitSpikeRouteForSearch('?v=44')).toBe('b');
    expect(portraitSpikeRouteForSearch('?v=45')).toBe('b');
    expect(portraitSpikeRouteForSearch('?v=46')).toBe('b');
    expect(portraitSpikeRouteForSearch('?v=47')).toBe('b');
