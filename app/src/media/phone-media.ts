...
/** Canonical bundler URL resolver; identity and ownership stay in story/media. */
export function phoneMediaUrlFor(id: PhoneProductMediaId, owner: SceneId): string {
  ...
  switch (id) {
    ...
    case 'figure3-initial-poster':
      return new URL('../../../assets/figure3-initial-paper.webp', import.meta.url).href;
